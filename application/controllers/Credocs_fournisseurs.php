...
class Credocs_fournisseurs extends CI_Controller {
	...
	function index() {
		$this->template->write('title', 'Credocs Fournisseurs', TRUE);
		$this->template->write('header', 'Credocs Fournisseurs');
		
		$crud = new grocery_CRUD();
		$crud->set_table('credocs_fournisseurs');
		$crud->set_subject('Credoc');
		
		$columns = ['Num_Credoc','Id_Fournisseur','Id_Achat','Id_Banque','Date_Echeance','Montant_Devise','Taux_Change','Devise'];
		$fields = ['Num_Credoc','Id_Fournisseur','Id_Achat','Id_Banque','Date_Echeance','Montant_Devise','Taux_Change','Devise','Date_Acceptation'];
		
		if ('read' == $crud->getState()) {
			$columns = ['Num_Credoc','Id_Fournisseur','Id_Achat','Id_Banque','Date_Echeance','Montant_Devise','Taux_Change','Devise','Montant_MAD','Date_Acceptation'];
		...
		$crud->display_as('Num_Credoc','Num Credoc');
		...
		$crud->set_relation('Id_Achat','achats_import','{Num_Facture} - {Date_Facture} - DUM {Num_DUM}', "DATE_SUB(CURRENT_DATE, INTERVAL $seuil_affichage_achats_en_mois MONTH) <= Date_Created", "Date_Facture DESC");
		...
		$crud->required_fields('Num_Credoc','Id_Fournisseur','Id_Achat','Id_Banque','Date_Echeance','Montant_Devise','Taux_Change','Devise');
