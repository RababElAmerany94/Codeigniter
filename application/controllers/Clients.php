...
class Clients extends CI_Controller
{
	...
	function index()
	{
		$this->template->write('title', 'Clients', TRUE);
		$this->template->write('header', 'Clients');
		
		$crud = new grocery_CRUD();
		$crud->set_table('clients');
		$crud->set_subject('Client');
		
		$columns = ['Id_Client', 'RaisonSociale', 'Ville', 'Telephone_1', 'Email_1'];
		$fields = ['Adresse', 'Ville', 'Pays', 'Telephone_1', 'Telephone_2', 'Email_1', 'Email_2', 'IBAN_1', 'IBAN_2'];
		
		if ('read' == $crud->getState()) {
			$columns = ['Id_Client', 'RaisonSociale', 'Adresse', 'Ville', 'Pays', 'Telephone_1', 'Telephone_2', 'Email_1', 'Email_2', 'IBAN_1', 'IBAN_2'];
			$fields[] = 'Id_Client';
		...
		$crud->required_fields('RaisonSociale', 'Adresse', 'Ville', 'Telephone_1');
